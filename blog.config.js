...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ZeroEgg', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '医生及加密爱好者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://mixin.work', // 网站地址
